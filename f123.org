...
Hide Package Archive Priorities:
[INS]
   [ State ]: STANDARD.
   An alist of priorities for packages. Hide
...
Hide Package Check Signature: [Value Menu] allow-unsigned
   [ State ]: STANDARD.
   Non-nil means to check package signatures when installing. Hide
...
Show Package Description face: [sample]
   Face used on package description summaries in the package menu.

Hide Package Directory List:
[INS] [DEL] Directory: /usr/share/emacs/25.2/site-lisp/elpa
[INS] [DEL] Directory: /usr/share/emacs/site-lisp/elpa
[INS]
   [ State ]: STANDARD.
   List of additional directories containing Emacs Lisp packages. Hide
   Each directory name should be absolute.
   
   These directories contain packages intended for system-wide; in
   contrast, ‘package-user-dir’ contains packages for personal use.

Hide Package Enable At Startup: [Toggle]  on (non-nil)
   [ State ]: SAVED and set.
   Whether to activate installed packages when Emacs starts. Hide
...
Show Package Help Section Name face: [sample]
   Face used on section names in package description buffers.

Hide Package Hidden Regexps:
[INS]
   [ State ]: STANDARD.
   List of regexps matching the name of packages to hide. Hide
   If the name of a package matches any of these regexps it is
   omitted from the package menu.  To toggle this, type M-x package-menu-toggle-hiding.
   
   Values can be interactively added to this list by typing
   M-x package-menu-hide-package on a package

Hide Package Load List:
[INS] [DEL] Choice: [Value Menu] all
[INS]
   [ State ]: STANDARD.
   List of packages for ‘package-initialize’ to load. Hide
...
Hide Package Menu Async: [Toggle]  on (non-nil)
   [ State ]: STANDARD.
   If non-nil, package-menu will use async operations when possible. Hide
   Currently, only the refreshing of archive contents supports
   asynchronous operations.  Package transactions are still done
   synchronously.

Hide Package Menu Hide Low Priority: [Value Menu] Don’t hide anything
   [ State ]: SAVED and set.
   If non-nil, hide low priority packages from the packages menu. Hide
   ...
   nil, so it can be toggled with  (.

Show Package Name face: [sample]
   Face used on package names in the package menu.

Hide Package Pinned Packages:
[INS]
   [ State ]: STANDARD.
   An alist of packages that are pinned to specific archives. Hide
...
Hide Package Selected Packages:
[INS] [DEL] Symbol: muse
[INS] [DEL] Symbol: web-server
[INS] [DEL] Symbol: csv-mode
[INS] [DEL] Symbol: company
[INS]
   [ State ]: SAVED and set.
   Store here packages installed explicitly by user. Hide
...
Entered on [2017-05-17 Wed 18:28]
*** 2017-05-20 Saturday
**** Calendar and Diary

Here's what I know so far:

I can change the name and location of the diary file: diary-file.

I have been less successful changing the month names and I don't know where the day names are stored.

I don't know where the default date format is stored.

European date format should be the default except for people living in the United States.

I don't kno how to see the diary entries from the calendar. This is pretty important.

I think I read that the diary can be displayed by default when emacs is started. That sounds good to me.
   Entered on [2017-05-20 Sat 15:48]
  
     [[<2017-05-20 Sat>]]
**** More on the Calendar

Longitutde and Lattitude must be set for sunrise and sunset to be calculated.

The phases of the moon work without doing anything.
   Entered on [2017-05-20 Sat 15:52]
*** 2017-05-21 Sunday
**** Personal Note to be disgarded

I don't get why =r= is not working. It seems like the final specification in any list doesn't work.
   Entered on [2017-05-21 Sun 13:56]
* 2017
** 2017-05 May
*** 2017-05-12 Friday
*** 2017-05-14 Sunday
